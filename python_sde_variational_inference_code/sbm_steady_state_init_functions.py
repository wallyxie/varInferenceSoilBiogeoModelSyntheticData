...
def analytical_steady_state_init_con(SOC_input, DOC_input, scon_params_dict, batch_size = 3):
    '''
    ...
    C_0_vector = C_0_vector.resize_((1, 3, 1)) #Need to reshape initial conditions to assign to C_vector.
