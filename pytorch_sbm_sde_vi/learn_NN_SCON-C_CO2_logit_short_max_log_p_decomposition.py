...
net, obs_model, norm_hist, ELBO_hist, log_p_hist, log_p_x_hist, log_p_y_giv_x_hist, samples_log_p_hist, samples_log_p_x_hist, samples_log_p_y_giv_x_hist, max_log_p_hist, times_per_iter_hist, SBM_SDE_instance, best_train_ELBO = train_nn_max_log_p_decomposition_save_fewer(active_device, elbo_lr, elbo_iter, batch_size,
...
now = datetime.now()
now_string = 'SCON-C_CO2_NN_max_log_p_decomposition' + now.strftime('_%Y_%m_%d_%H_%M_%S')
...
samples_log_p_x_save_string = os.path.join(outputs_folder, 'samples_log_p_x' + save_string)
samples_log_p_y_giv_x_save_string = os.path.join(outputs_folder, 'samples_log_p_y_giv_x' + save_string)
...
torch.save(samples_log_p_x_hist, samples_log_p_x_save_string)
torch.save(samples_log_p_y_giv_x_hist, samples_log_p_y_giv_x_save_string)
