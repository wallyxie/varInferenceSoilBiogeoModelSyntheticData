...
from SBM_SDE_instancees import *
...
net, q_theta, p_theta, obs_model, ELBO_hist, list_parent_loc_scale, SBM_SDE_instance = train(
...
now = datetime.now()
now_string = 'SCON-C_CO2_logit_alt_' + now.strftime('%Y_%m_%d_%H_%M_%S')
