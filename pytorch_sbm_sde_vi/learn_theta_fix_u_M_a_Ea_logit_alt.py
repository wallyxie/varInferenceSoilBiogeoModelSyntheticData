...
priors_file = 'generated_data/SCONR_C_fix_u_M_a_Ea_logit_alt_sample_y_t_1000_dt_0-01_sd_scale_0-333_hyperparams.pt'
SCONR_C_fix_u_M_a_Ea_priors_details = {k: v.to(active_device) for k, v in torch.load(priors_file).items()}
...
csv_data_path = os.path.join('generated_data/', 'SCONR_C_fix_u_M_a_Ea_logit_alt_sample_y_t_1000_dt_0-01_sd_scale_0-333.csv')
...
now = datetime.now()
now_string = 'SCONR_C_fix_u_M_a_Ea_logit_alt_' + now.strftime('%Y_%m_%d_%H_%M_%S')
