...
net, q_theta, p_theta, obs_model, norm_hist, ELBO_hist, log_p_hist, log_p_theta_hist, log_p_x_giv_theta_hist, log_p_y_giv_x_theta_hist, times_per_iter_hist, SBM_SDE_instance, best_train_ELBO = train_log_p_decomposition(
