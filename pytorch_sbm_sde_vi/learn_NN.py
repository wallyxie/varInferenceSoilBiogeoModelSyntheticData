...
t = 2000 #5000. Reduced to see impact on memory. #In hours.
n = int(t / dt_flow) + 1
...
#Training parameters
niter = 30001 #Total number of training iterations, including ELBO iterations.
piter = 1200 #Number of pre-training iterations.
