...
t = 2700 #5000. Reduced to see impact on memory. #In hours.
n = int(t / dt_flow) + 1
...
#Training parameters
niter = 60000 #Total number of training iterations, including ELBO iterations.
piter = 210 #Number of pre-training iterations.
