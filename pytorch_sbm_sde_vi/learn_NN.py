...
t = 1900 #5000. Reduced to see impact on memory. #In hours.
n = int(t / dt_flow) + 1
...
#Training parameters
niter = 5001 #Total number of training iterations, including ELBO iterations.
piter = 550 #Number of pre-training iterations.
pretrain_lr = 2e-3 #Norm regularization learning rate
train_lr = 1e-3 #ELBO learning rate
batch_size = 6 #3 - number needed to fit UCI HPC3 RAM requirements with 16 GB RAM at t = 5000.
eval_batch_size = 5
