...
#Training parameters
niter = 5000 #Total number of training iterations, including ELBO iterations.
piter = 0 #Number of pre-training iterations.
...
net, ELBO_hist = train(active_device, pretrain_lr, train_lr, niter, piter, batch_size, num_layers,
          ...
          LEARN_THETA = False, LR_DECAY = 0.95, DECAY_STEP_SIZE = 2000, PRINT_EVERY = 10)
