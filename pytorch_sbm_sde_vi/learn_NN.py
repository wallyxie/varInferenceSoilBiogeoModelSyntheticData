...
#Training parameters
niter = 17001 #Total number of training iterations, including ELBO iterations.
piter = 1000 #Number of pre-training iterations.
pretrain_lr = 1e-3 #Norm regularization learning rate
train_lr = 1e-4 #ELBO learning rate
batch_size = 8 #3 - number needed to fit UCI HPC3 RAM requirements with 16 GB RAM at t = 5000.
eval_batch_size = 8
