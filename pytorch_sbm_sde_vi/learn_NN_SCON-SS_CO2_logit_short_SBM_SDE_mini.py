...
#Module imports
from training_SBM_SDE_mini import *
...
net, obs_model, norm_hist, ELBO_hist, SBM_SDE_instance = train_nn_SBM_SDE_mini(active_device, elbo_lr, elbo_iter, batch_size,
...
now = datetime.now()
now_string = 'SCON-SS_CO2_NN_SBM_SDE_mini' + now.strftime('_%Y_%m_%d_%H_%M_%S')
