...
u_M_dist = torch.Tensor([0.0016, 0.0016 * prior_scale_factor, 0, 1]).to(active_device)
a_SD_dist = torch.Tensor([0.5, 0.5 * prior_scale_factor, 0, 1]).to(active_device)
a_DS_dist = torch.Tensor([0.5, 0.5 * prior_scale_factor, 0, 1]).to(active_device)
a_M_dist = torch.Tensor([0.5, 0.5 * prior_scale_factor, 0, 1]).to(active_device)
a_MSC_dist = torch.Tensor([0.5, 0.5 * prior_scale_factor, 0, 1]).to(active_device)
k_S_ref_dist = torch.Tensor([0.0005, 0.0005 * prior_scale_factor, 0, 1]).to(active_device)
k_D_ref_dist = torch.Tensor([0.0008, 0.0008 * prior_scale_factor, 0, 1]).to(active_device)
k_M_ref_dist = torch.Tensor([0.0007, 0.0007 * prior_scale_factor, 0, 1]).to(active_device)
Ea_S_dist = torch.Tensor([55, 55 * prior_scale_factor, 20, 120]).to(active_device)
Ea_D_dist = torch.Tensor([48, 48 * prior_scale_factor, 20, 120]).to(active_device)
Ea_M_dist = torch.Tensor([48, 48 * prior_scale_factor, 20, 120]).to(active_device)

#SCON-C diffusion matrix parameter truncated normal prior distribution parameter details in order of mean, lower, and upper. 
c_SOC_dist = torch.Tensor([0.1, 0.1 * prior_scale_factor, 0, 1]).to(active_device)
c_DOC_dist = torch.Tensor([0.002, 0.002 * prior_scale_factor, 0, 1]).to(active_device)
c_MBC_dist = torch.Tensor([0.002, 0.002 * prior_scale_factor, 0, 1]).to(active_device)
...
obs_times, obs_means_noCO2, obs_error = csv_to_obs_df('trunc_sample_y_from_x_t_1000_dt_0-01.csv', state_dim_SCON, t, obs_error_scale)
