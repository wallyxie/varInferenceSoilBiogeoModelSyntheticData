...
u_M_details = torch.Tensor([0.0016, 0.0016 * prior_scale_factor, 0, 0.01]).to(active_device)
...
k_S_ref_details = torch.Tensor([0.0005, 0.0005 * prior_scale_factor, 0, 0.005]).to(active_device)
k_D_ref_details = torch.Tensor([0.0008, 0.0008 * prior_scale_factor, 0, 0.005]).to(active_device)
k_M_ref_details = torch.Tensor([0.0007, 0.0007 * prior_scale_factor, 0, 0.005]).to(active_device)
...
c_SOC_details = torch.Tensor([0.1, 0.1 * prior_scale_factor, 0, 0.5]).to(active_device)
c_DOC_details = torch.Tensor([0.002, 0.002 * prior_scale_factor, 0, 0.01]).to(active_device)
c_MBC_details = torch.Tensor([0.002, 0.002 * prior_scale_factor, 0, 0.01]).to(active_device)
