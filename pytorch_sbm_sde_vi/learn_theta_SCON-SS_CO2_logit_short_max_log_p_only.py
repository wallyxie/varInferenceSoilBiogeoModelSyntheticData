...
net, q_theta, p_theta, obs_model, norm_hist, ELBO_hist, log_p_hist, max_log_p_hist, times_per_iter_hist, SBM_SDE_instance, best_train_ELBO = train_max_log_p_only(
...
now = datetime.now()
now_string = 'SCON-SS_CO2_logit_short_max_log_p_only' + now.strftime('_%Y_%m_%d_%H_%M_%S')
