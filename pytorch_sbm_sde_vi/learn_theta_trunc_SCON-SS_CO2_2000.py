...
now = datetime.now()
now_string = 'SCON-SS_CO2_trunc_2000' + now.strftime('_%Y_%m_%d_%H_%M_%S')
...
true_theta = torch.load('generated_data/SCON-SS_CO2_trunc_2000_2021_10_06_16_32_sample_y_t_2000_dt_0-01_sd_scale_0-333_rsample.pt', map_location = active_device)
...
plot_states_post(x, q_theta, obs_model, SBM_SDE_instance, niter, t, dt_flow, batch_size, eval_batch_size, num_layers, train_lr, prior_scale_factor, plots_folder, now_string, learn_CO2, ymin_list = [0, 0, 0, 0], ymax_list = [100., 20., 22., 0.1])
