...
net, obs_model, norm_hist, ELBO_hist, SBM_SDE_instance = train_old(active_device, elbo_lr, elbo_iter, batch_size,
...
now = datetime.now()
now_string = 'SCON-SS_CO2_logit_short_only_intmd_base' + now.strftime('_%Y_%m_%d_%H_%M_%S')
