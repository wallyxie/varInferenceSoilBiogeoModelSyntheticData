...
init_file = 'generated_data/SCON-C_CO2_trunc_sample_y_t_1000_dt_0-01_sd_scale_0-333_hyperparams.pt'
...
now = datetime.now()
now_string = 'SCON_C_trunc_multi_' + now.strftime('%Y_%m_%d_%H_%M_%S')
