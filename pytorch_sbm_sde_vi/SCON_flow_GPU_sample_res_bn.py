...
from obs_and_flow_res_bn import *
...
now_string = 'SCON-C_CO2_logit_short_res_bn_2022_03_10_22_46_59'
outputs_folder = 'training_pt_outputs/'
plots_folder = 'training_plots/'
save_string = '_iter_110000_warmup_5000_t_5000_dt_1.0_batch_31_layers_2_lr_0.001_decay_step_15000_warmup_lr_1e-06_sd_scale_0.25_SCON-C_CO2_logit_short_res_bn_2022_03_10_22_46_59.pt'
...
#Save net.train() samples from trained net object.
batch_multiples = 1
with torch.no_grad():
...
#Save net.eval() samples from trained net object.
net.eval()
with torch.no_grad():
    for i in range(batch_multiples):
        print(i)
