...
u_M_details = torch.Tensor([logit(torch.tensor([0.0016]), torch.tensor([0]), torch.tensor([0.1])), 0.0016 * prior_scale_factor, 0, 0.1]).to(active_device)
...
c_DOC_details = torch.Tensor([logit(torch.tensor([0.002]), torch.tensor([0]), torch.tensor([0.02])), 0.002 * prior_scale_factor, 0, 0.02]).to(active_device)
c_MBC_details = torch.Tensor([logit(torch.tensor([0.002]), torch.tensor([0]), torch.tensor([0.02])), 0.002 * prior_scale_factor, 0, 0.02]).to(active_device)
