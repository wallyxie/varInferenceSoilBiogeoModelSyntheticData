...
csv_data_path = os.path.join('generated_data/', 'SCON-SS_CO2_trunc_5000_diff_theta_2021_10_12_16_48_sample_y_t_5000_dt_0-01_sd_scale_0-333.csv')
...
plot_states_post(x, q_theta, obs_model, SBM_SDE_instance, niter, t, dt_flow, batch_size, eval_batch_size, num_layers, train_lr, prior_scale_factor, plots_folder, now_string, learn_CO2, ymin_list = [0, 0, 0, 0], ymax_list = [150., 20., 40., 0.25])
