...
csv_data_path = os.path.join('generated_data/', 'SCON-SS_no_CO2_logit_alt_2021_09_27_18_54_sample_y_t_1000_dt_0-01_sd_scale_0-333.csv')
...
now = datetime.now()
now_string = 'SCON-SS_no_CO2_logit_alt' + now.strftime('_%Y_%m_%d_%H_%M_%S')
