...
SCONR_C_fix_u_M_a_Ea_c_priors_details = {'k_S_ref': k_S_ref_details, 'k_D_ref': k_D_ref_details, 'k_M_ref': k_M_ref_details}
...
csv_data_path = os.path.join('generated_data/', 'SCONR_C_fix_u_M_a_Ea_c_trunc_sample_y_t_1000_dt_0-01_sd_scale_0-333.csv')
...
now = datetime.now()
now_string = 'SCONR_C_fix_u_M_a_Ea_c_trunc_' + now.strftime('%Y_%m_%d_%H_%M_%S')
