...
SCON_SS_priors_details = {'a_SD': a_SD_details, 'a_DS': a_DS_details, 'a_M': a_M_details, 'a_MSC': a_MSC_details, 'k_S_ref': k_S_ref_details, 'k_D_ref': k_D_ref_details, 'k_M_ref': k_M_ref_details, 'Ea_S': Ea_S_details, 'Ea_D': Ea_D_details, 'Ea_M': Ea_M_details, 's_SOC': s_SOC_details, 's_DOC': s_DOC_details, 's_MBC': s_MBC_details}
...
csv_data_path = os.path.join('generated_data/', 'SCON-SS_fix_u_M_no_CO2_trunc_2021_10_03_15_09_sample_y_t_1000_dt_0-01_sd_scale_0-333.csv')
...
now = datetime.now()
now_string = 'SCON-SS_fix_u_M_no_CO2_trunc' + now.strftime('_%Y_%m_%d_%H_%M_%S')
...
true_theta = torch.load('generated_data/SCON-SS_fix_u_M_CO2_trunc_2021_10_03_15_09_sample_y_t_1000_dt_0-01_sd_scale_0-333_rsample.pt', map_location = active_device)
...
plot_states_post(x, q_theta, obs_model, SBM_SDE_instance, niter, t, dt_flow, batch_size, eval_batch_size, num_layers, train_lr, prior_scale_factor, plots_folder, now_string, learn_CO2, ymin_list = [0, 0, 0, 0], ymax_list = [90., 25., 20., 0.1])
