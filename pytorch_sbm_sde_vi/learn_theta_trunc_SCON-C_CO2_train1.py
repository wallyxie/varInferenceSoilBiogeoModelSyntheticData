...
net, q_theta, p_theta, obs_model, ELBO_hist, list_parent_loc_scale, SBM_SDE_instance = train1(
...
print('train1 time: ', end - start)

#Save net and ELBO files.
now = datetime.now()
now_string = 'SCON-C_CO2_trunc_train1' + now.strftime('_%Y_%m_%d_%H_%M_%S')
