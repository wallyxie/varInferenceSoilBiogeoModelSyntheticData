...
SCON_C_priors_details = {k: v.to(active_device) for k, v in torch.load(os.path.join('generated_data/', 'SCON-C_CO2_logit_short_dense_2022_05_12_16_03_sample_y_t_5000_dt_0-01_sd_scale_0-25_hyperparams.pt')).items()}

#Initial condition prior means
x0_SCON_tensor = torch.load(os.path.join('generated_data/', 'SCON-C_CO2_logit_short_dense_2022_05_12_16_03_sample_y_t_5000_dt_0-01_sd_scale_0-25_x0_SCON_tensor.pt')).to(active_device)
...
csv_data_path = os.path.join('generated_data/', 'SCON-C_CO2_logit_short_dense_2022_05_12_16_03_sample_y_t_5000_dt_0-01_sd_scale_0-25.csv')
...
now = datetime.now()
now_string = 'SCON-C_CO2_logit_short_dense' + now.strftime('_%Y_%m_%d_%H_%M_%S')
...
true_theta = torch.load(os.path.join('generated_data/', 'SCON-C_CO2_logit_short_dense_2022_05_12_16_03_sample_y_t_5000_dt_0-01_sd_scale_0-25_rsample.pt'), map_location = active_device)
