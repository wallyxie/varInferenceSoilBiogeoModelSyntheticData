...
SCON_SS_priors_details = {k: v.to(active_device) for k, v in torch.load('generated_data/SCON-SS_fix_u_M_a_Ea_CO2_trunc_2021_10_04_18_22_sample_y_t_1000_dt_0-01_sd_scale_0-333_hyperparams.pt').items()}

SCON_SS_fix_u_M_a_dict = {k: v.to(active_device) for k, v in torch.load('generated_data/SCON-SS_fix_u_M_a_Ea_CO2_trunc_2021_10_04_18_22_sample_y_t_1000_dt_0-01_sd_scale_0-333_fix_dict.pt').items()}
...
csv_data_path = os.path.join('generated_data/', 'SCON-SS_fix_u_M_a_Ea_no_CO2_trunc_2021_10_04_18_22_sample_y_t_1000_dt_0-01_sd_scale_0-333.csv')
...
now = datetime.now()
now_string = 'SCON-SS_fix_u_M_a_Ea_no_CO2_trunc' + now.strftime('_%Y_%m_%d_%H_%M_%S')
...
true_theta = torch.load('generated_data/SCON-SS_fix_u_M_a_Ea_CO2_trunc_2021_10_04_18_22_sample_y_t_1000_dt_0-01_sd_scale_0-333_rsample.pt', map_location = active_device)
