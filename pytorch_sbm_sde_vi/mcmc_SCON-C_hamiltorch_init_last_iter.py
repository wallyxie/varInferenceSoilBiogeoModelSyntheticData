...
def main(args):
    ...
    init_file = os.path.join(init_dir, '{}.pt'.format(args.init_name)) # init_name = 'SCON-C_init_theta_mode_x_sample.pt'

    # Output file
    offset = int(args.out_offset)
    ...
    run_hamiltorch(args, model_params, in_filenames, out_filenames,
                   fix_theta_file=False, init='last_iter', init_file=init_file, offset=offset)
