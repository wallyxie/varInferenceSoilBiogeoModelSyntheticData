...
net, q_theta, p_theta, obs_model, norm_hist, ELBO_hist, log_p_hist, log_p_theta_hist, log_p_x_giv_theta_hist, log_p_y_giv_x_theta_hist, samples_log_p_hist, samples_log_p_theta_hist, samples_log_p_x_giv_theta_hist, samples_log_p_y_giv_x_theta_hist, max_log_p_hist, times_per_iter_hist, SBM_SDE_instance, best_train_ELBO = train_max_log_p_decomposition_save_fewer(
...
now = datetime.now()
now_string = 'SCON-SS_CO2_logit_short_max_log_p_decomposition' + now.strftime('_%Y_%m_%d_%H_%M_%S')
...
samples_log_p_save_string = os.path.join(outputs_folder, 'samples_log_p' + save_string)
samples_log_p_theta_save_string = os.path.join(outputs_folder, 'samples_log_p_theta' + save_string)
samples_log_p_x_giv_theta_save_string = os.path.join(outputs_folder, 'samples_log_p_x_giv_theta' + save_string)
samples_log_p_y_giv_x_theta_save_string = os.path.join(outputs_folder, 'samples_log_p_y_giv_x_theta' + save_string)
max_log_p_save_string = os.path.join(outputs_folder, 'max_log_p' + save_string)
...
torch.save(samples_log_p_hist, samples_log_p_save_string)
torch.save(samples_log_p_theta_hist, samples_log_p_theta_save_string)
torch.save(samples_log_p_x_giv_theta_hist, samples_log_p_x_giv_theta_save_string)
torch.save(samples_log_p_y_giv_x_theta_hist, samples_log_p_y_giv_x_theta_save_string)
torch.save(max_log_p_hist, max_log_p_save_string)
