...
def plot_theta(p_theta, q_theta, niter, piter, t, dt, batch_size, eval_batch_size, num_layers, now_string,
               nrows=4, ncols=4):
    ...
    plt.tight_layout()
    fig.savefig(f'theta_iter_{niter}_piter_{piter}_t_{t}_dt_{dt}_batch_{batch_size}_samples_{eval_batch_size}_layers_{num_layers}_{now_string}.png', dpi = 300)
