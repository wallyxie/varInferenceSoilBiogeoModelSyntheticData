...
def train(DEVICE, ELBO_LR: float, ELBO_ITER: int, BATCH_SIZE: int,
    ...
    return net, q_theta, priors, obs_model, norm_losses, ELBO_losses, times_per_iter, SBM_SDE
...
def train_log_p_decomposition(DEVICE, ELBO_LR: float, ELBO_ITER: int, BATCH_SIZE: int,
    ...
    return net, q_theta, priors, obs_model, norm_losses, ELBO_losses, log_p_losses, log_p_theta_losses, log_p_x_giv_theta_losses, log_p_y_giv_x_theta_losses, times_per_iter, SBM_SDE
...
def train_max_log_p_decomposition(DEVICE, ELBO_LR: float, ELBO_ITER: int, BATCH_SIZE: int,
    ...
    return net, q_theta, priors, obs_model, norm_losses, ELBO_losses, log_p_losses, log_p_theta_losses, log_p_x_giv_theta_losses, log_p_y_giv_x_theta_losses, samples_log_p_losses, samples_log_p_theta_losses, samples_log_p_x_giv_theta_losses, samples_log_p_y_giv_x_theta_losses, max_log_p_losses, times_per_iter, SBM_SDE
...
def train_nn(DEVICE, ELBO_LR: float, ELBO_ITER: int, BATCH_SIZE: int,
    ...
    return net, obs_model, norm_losses, ELBO_losses, times_per_iter, SBM_SDE
...
def train_nn_log_p(DEVICE, ELBO_LR: float, ELBO_ITER: int, BATCH_SIZE: int,
    ...
    return net, obs_model, norm_losses, ELBO_losses, log_p_losses, times_per_iter, SBM_SDE
...
def train_nn_log_p_decomposition(DEVICE, ELBO_LR: float, ELBO_ITER: int, BATCH_SIZE: int,
    ...
    return net, obs_model, norm_losses, ELBO_losses, log_p_losses, log_p_x_losses, log_p_y_giv_x_losses, times_per_iter, SBM_SDE
...
def train_nn_max_log_p_decomposition(DEVICE, ELBO_LR: float, ELBO_ITER: int, BATCH_SIZE: int,
    ...
    return net, obs_model, norm_losses, ELBO_losses, log_p_losses, log_p_x_losses, log_p_y_giv_x_losses, samples_log_p_losses, samples_log_p_x_losses, samples_log_p_y_giv_x_losses, max_log_p_losses, times_per_iter, SBM_SDE
