...
priors_file = 'generated_data/SCONR_C_fix_k_logit_alt_sample_y_t_1000_dt_0-01_sd_scale_0-333_hyperparams.pt'
...
csv_data_path = os.path.join('generated_data/', 'SCONR_C_fix_k_logit_alt_sample_y_t_1000_dt_0-01_sd_scale_0-333.csv')
